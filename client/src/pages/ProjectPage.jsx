...
function ProjectPage({ token, currentUserId }) {
        ...
        <div className="space-y-4">
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
            <div className="flex items-center justify-between gap-3">
              <div>
                <h3 className="text-lg font-bold text-slate-950">Start a project</h3>
                <p className="mt-2 text-sm text-slate-600">
                  Create a collaboration space and invite others to join.
                </p>
              </div>
              <button
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50 p-5">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">
                  Join an existing collaboration or view the current team.
                </p>
              </div>
